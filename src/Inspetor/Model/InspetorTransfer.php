...
class InspetorTransfer extends InspetorAbstractModel implements JsonSerializable {
    ...
    public function isValid () {
		...
		if (!$this->item_id) {
            throw new InspetorTransferException(7003);
        }

		if (!$this->sender_account_id) {
            throw new InspetorTransferException(7004);
        }

		if (!$this->receiver_email) {
            throw new InspetorTransferException(7005);
		}
    ...
    private function validateStatus() {
        ...
        if (!in_array($this->status, $all_status)) {
            throw new InspetorTransferException(7006);
        }
    }
